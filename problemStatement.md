...
*   **Target corpus limited to the following 5 scheme URLs:**
    1. [HDFC Mid-Cap Opportunities Fund Direct-Growth](https://groww.in/mutual-funds/hdfc-mid-cap-fund-direct-growth)
    2. [HDFC Top 100 Fund (Large Cap) Direct-Growth](https://groww.in/mutual-funds/hdfc-large-cap-fund-direct-growth)
...
*   Fund management details (fund managers, experience, tenure, etc.)
...
### Data and Sources
*   Use the specified 5 scheme URLs on Groww as the exclusive source corpus.
*   Do **not** use third-party blogs or unrelated aggregator websites.
